  ...
  return (
    <section className="bg-white -m-3 -ml-6 dark:bg-gray-900">
      <div className="container px-6 py-10 mx-auto">
        <h1 className="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl dark:text-white">Our Technicians</h1>

        <p className="max-w-2xl mx-auto my-6 text-center text-gray-500 dark:text-gray-300">
          Discover trusted technicians recommended by your residence's admin, simplifying your search for reliable service providers</p>
        {user.Type === 'Admin' && (
          <div className=" mb-5 flex justify-end">
            <Link to='/AddTech' className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-3 rounded transition duration-300 ease-in-out text-sm">
              Add Tech
            </Link>
          </div>
        )}
            ...
            <div className="w-full mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
              <div className="p-3">
                <div className="overflow-x-auto">
                  {loading && (
                    <Lottie animationData={LoadingAnim} className='' />
                        ...
                        <tr key={index} >
                          <td className="p-2 whitespace-nowrap">
                            <div className="flex items-center">
                              <div className="w-16 h-16 flex-shrink-0 mr-2 sm:mr-3"><img className="rounded-full h-14 w-16" src={metierspic.find(job => job.id === technician.id_metier)?.image} alt="Alex Shatov" /></div>
                              <div className="font-medium text-gray-800">{technician.Nom} {technician.Prenom}</div>
                            </div>
                          </td>
                          <td className="p-2 whitespace-nowrap">
                          ...
                          <td className="p-2 whitespace-nowrap">
                            <div className="text-left font-medium text-green-500"> {metiers.find(job => job.id === technician.id_metier)?.nom_metier}</div>
                          </td>
                          <td className="p-2 whitespace-nowrap">
                            <div className="text-lg text-center">{user.Type === 'Admin' && (
                              <button
